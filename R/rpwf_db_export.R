...
#' Export the [rpwf_add_all()] object into the database and write the parquets
#'
#' @param obj object generated by [rpwf_add_all()]
#' @inheritParams rpwf_dm_obj
#'
