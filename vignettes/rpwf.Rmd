...
# db is at /tmp/RtmpNMsSNR/vignette44bb4c7d4218/rpwfDb/db.SQLite
# Creating the db.SQLite_results folder
# Connecting to sqlite:////tmp/RtmpNMsSNR/vignette44bb4c7d4218/rpwfDb/db.SQLite
#    wflow_id      model_tag recipe_tag                               py_base_learner_args result_path
# 0         1  XGBClassifier   xgb_base  {"eval_metric":"logloss","n_estimators":50,"us...        None
# 1         2  XGBClassifier    xgb_pca  {"eval_metric":"logloss","n_estimators":50,"us...        None
# 2         3       svm_poly   svm_base                 {"kernel":"poly","cache_size":500}        None
# 3         4        svm_rbf   svm_base                  {"kernel":"rbf","cache_size":500}        None
# 4         5       svm_poly    svm_pca                 {"kernel":"poly","cache_size":500}        None
# 5         6        svm_rbf    svm_pca                  {"kernel":"rbf","cache_size":500}        None  
```
