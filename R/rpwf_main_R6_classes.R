...
#' that requires tuning. Called by [dplyr::rename_with()] in [rpwf_grid_gen()].
#'
...
#'
#' @examples
#' rename_fns <- rpwf_grid_rename(jsonlite::toJSON(list("mtry" = "colsample_bytree")))
#' rename_fns(c("mtry", "not_added"))
rpwf_grid_rename <- function(json) {
