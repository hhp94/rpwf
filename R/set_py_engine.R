...
#' @param py_module string of what the py module is e.g., xgboost, sklearn.ensemble
#' @param py_base_learner string of what the base learner is e.g., XGBClassifier
