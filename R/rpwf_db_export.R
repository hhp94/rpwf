...
#' parquets, and updating the database of the provided R grids.
#'
...
#'
#' Add the [TrainDf] R6 objects using provided recipes. Similar to [rpwf_add_grids()],
#' this object does the heavy lifting of generating the path, parquet, and
#' updating the database of the recipe transformed data.
#'
...
#'
#' @param df object created by [rpwf_add_all()].
#'
...
#' Export the [rpwf_add_all()] Object into the Database
#'
